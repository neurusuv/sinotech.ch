...
class wps_ic_enqueues extends wps_ic
{
  ...
  public function enqueue_frontend()
  {
    ...
    if ((!empty($options['lazy']) && $options['lazy'] == '1')) {
      ...
      wp_localize_script($this::$slug . '-aio', 'ngf298gh738qwbdh0s87v_vars', ['zoneName' => get_option('ic_cdn_zone_name'), 'siteurl'
  ...
  public function enqueue_tracking_script()
  {
    if (!empty(self::$zone_name) && empty($_GET['disableTracking'])) {
      ?>
        <img src="https://<?php echo self::$zone_name; ?>/stats.api" class="no-delay" alt="" width="1" height="1" style="display:none !important;"/>
