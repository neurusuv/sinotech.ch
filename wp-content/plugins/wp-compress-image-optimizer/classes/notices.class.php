...
class wps_ic_notices extends wps_ic {
	...
	public function show_notice(
		...
		string $dismiss_tag = '', $info = []
	) {
		new wps_ic_admin_notice( $title, $message, $type, $global, $dismiss_tag, $info );
	}
...
class wps_ic_admin_notice {
	...
	function __construct( $title, $message, $type, $global, $dismiss_tag, $info ) {
		$this->title   = $title;
      ...
      <div class="notice notice-<?php echo $this->type; ?> wpc-ic-notice wps-ic-tag-<?php echo $this->tag; ?>">
          ...
          <div class="wps-ic-notice-content">
              ...
              <div style="margin-left:auto">
								<?php echo '<a href="#" class="wps-ic-fix-notice button-secondary" style="margin-right:5px;" data-tag="' .
                                           $this->tag .
								           '" data-plugin="' .
