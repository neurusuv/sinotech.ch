...
//    );
  ...
  public static function purgeCDNUpdate() {
    ...
    $call = wp_remote_get(WPS_IC_KEYSURL . '?action=cdn_purge&apikey=' . $options['api_key'], ['timeout' => 10, 'sslverify' => 'false', 'user-agent' => 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8; rv:20.0) Gecko/20100101 Firefox/20.0']);
