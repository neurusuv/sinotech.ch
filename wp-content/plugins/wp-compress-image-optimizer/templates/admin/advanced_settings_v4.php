              ...
              <div class="wpc-settings-tab-content-inner">
                ...
                <div class="wpc-tab-content" id="image-optimization-options" style="display:none;">
                  ...
                  <div class="wpc-tab-content-box" id="lazy-images">
                    <?php #echo $gui::TabTitle_InputField('Lazy Loading', 'Intelligently lazy load images based on the viewport position.', 'image-optimization/image-optimization.svg', '', 'lazy-images'); ?>
                    <?php echo $gui::checkboxTabTitle('Lazy Loading', 'Intelligently lazy load images based on the viewport position.', 'image-optimization/image-optimization.svg', '', ''); ?>
