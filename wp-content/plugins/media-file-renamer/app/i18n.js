...
i18n.DASHBOARD_FILTERS = {
  TITLE: __( 'No Title', 'media-file-renamer' ),
  ALT_TEXT: __( 'No ALT Text', 'media-file-renamer' ),
  DESCRIPTION: __( 'No Description', 'media-file-renamer' ),
};
...
i18n.SETTINGS = {
  ...
  METADATA_TITLE: __( 'Title', 'media-file-renamer' ),
  METADATA_ALT_TEXT: __( 'Alternative Text', 'media-file-renamer' ),
  METADATA_DESCRIPTION: __( 'Description', 'media-file-renamer' ),
  UI_FEATURES: __( 'UI Features', 'media-file-renamer' ),
  ADVANCED: __( 'Advanced', 'media-file-renamer' ),
  RENAMING: __( 'Renaming', 'media-file-renamer' ),
  CLEAN_UPLOAD: __( 'Clean Uploads', 'media-file-renamer' ),
  CLEAN_UPLOAD_DESCRIPTION: __( 'Automatically assign Title, Alt Text, Caption, and Description based on refined file names.', 'media-file-renamer' ),
  ...
  ON_UPLOAD_DESCRIPTION: __( 'Rename files on upload with EXIF titles, if present.', 'media-file-renamer' ),
  ...
  AI_ENGINE_INSTALLED: __( "AI Engine is installed.", 'media-file-renamer' ),
